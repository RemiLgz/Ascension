...
public class SkillUpgradeManager : MonoBehaviour
{
    ...
    public float multiplierCubesPerClick = 1.5f; // Multiplicateur pour l'augmentation de cubesPerClick
    ...
    void UpgradeSkill()
    {
        ...
        if (powerBarManager.playerPower >= prix)
        {
            ...
            // Augmenter cubesPerClick de façon exponentielle mais contrôlée
            powerBarManager.cubesPerClick = Mathf.RoundToInt(powerBarManager.cubesPerClick * multiplierCubesPerClick);
